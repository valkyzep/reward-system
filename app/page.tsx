...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col overflow-visible">
      ...
      <AnimatePresence>
        {showWelcomeModal && (
          <motion.div
            ...
            style={{
              backgroundImage: 'url(/fullmodal.png)',
          ...
          >
            ...
            <motion.div
              ...
              className="absolute lg:relative bottom-0 lg:bottom-auto z-10 h-[55%] lg:h-full w-full lg:w-3/5 flex flex-col items-center lg:items-start justify-end lg:justify-center p-6 pb-12 lg:p-15 lg:pl-[100px] font-poppins"
            ...
            >
              ...
              <div className="mb-4 lg:mb-8 w-full flex flex-col items-center lg:items-start welcome-modal-content">
                ...
                <div className="lg:hidden flex flex-row items-center justify-center w-full" style={{ gap: 'clamp(0.5rem, 2vw, 0.75rem)' }}>
                  <div className="bg-black/70 rounded-xl text-white shadow-lg border-l-4 border-orange-500" style={{ padding: 'clamp(0.5rem, 2vw, 1rem) clamp(0.75rem, 2.5vw, 1rem)' }}>
                    <div className="font-bold mb-1 welcome-modal-stats-number" style={{ fontSize: 'clamp(1rem, 3vw, 1.25rem)' }}>55</div>
                    <div className="font-semibold text-orange-300 welcome-modal-stats-label" style={{ fontSize: 'clamp(0.625rem, 1.5vw, 0.75rem)' }}>Rewards Claimed</div>
                  </div>
                  <div className="bg-black/70 rounded-xl text-white shadow-lg border-l-4 border-yellow-400" style={{ padding: 'clamp(0.5rem, 2vw, 1rem) clamp(0.75rem, 2.5vw, 1rem)' }}>
                    <div className="font-bold mb-1 welcome-modal-stats-number" style={{ fontSize: 'clamp(1rem, 3vw, 1.25rem)' }}>23K</div>
                    <div className="font-semibold text-yellow-200 welcome-modal-stats-label" style={{ fontSize: 'clamp(0.625rem, 1.5vw, 0.75rem)' }}>Active Players</div>
                  </div>
                </div>
                </div>
              </div>
      ...
      <div className="w-full bg-gradient-to-b from-gray-800 to-gray-900 py-0 px-4 overflow-visible">
              ...
              >
                <div className="relative group h-full">
                  ...
                  <div className="transition-all duration-200 h-full" style={{aspectRatio: '1180/1756'}}>
                    <div 
                      className={`relative flex flex-col items-center justify-end shadow-2xl transition-all duration-200 w-full h-full overflow-hidden ${tierStyles.className}`}
                      style={{
                        borderRadius: '42px',
                    ...
                    >
                      ...
                      <div className="pl-4 pr-2 pb-4 w-full flex flex-col gap-1" style={{ height: '25%', fontFamily: 'Poppins'}}>
                        {/* Item name and points row */}
                        <div className="flex justify-between items-center w-full">
                          <span className="font-bold text-white" style={{ fontSize: '26px', width: '55%', lineHeight: '26px'}}>{item.name}</span>
                          <div className="flex flex-col items-end gap-1 justify-start" style={{ alignSelf: 'flex-start', width: '45%'}}>
                            <div className="flex pt-2 items-start gap-1">
                              <img src="/pts.png" alt="Points" style={{ width: '15px', height: '15px', marginTop: '0px' }} />
                              <span className="font-bold text-white p-0" style={{ fontSize: '17px', lineHeight: '17px' }}>{item.points.toLocaleString()} Pts</span>
                            </div>
                          </div>
                        </div>
      ...
      {mobileFiltersOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute right-0 top-0 h-full w-80 max-w-[85vw] bg-gray-800 p-4 overflow-y-auto">
            ...
            <div className="mb-5">
              <h4 className="text-xs font-semibold text-white uppercase tracking-wider mb-3">Category</h4>
            ...
            {/* Mobile Tier Filter */}
            <div className="mb-5">
              <h4 className="text-xs font-semibold text-white uppercase tracking-wider mb-3">Prestige Tier</h4>
              <div className="space-y-1">
                {tiers.map(tier => (
      ...
      <div className="flex flex-1 w-full overflow-visible">
        ...
        <aside className="hidden md:flex flex-col w-72 bg-gray-800 rounded-xl mx-8 mt-4 p-6 shadow-lg h-fit self-start">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-2xl font-semibold text-white">Active Filters</h3>
            {activeFilterCount > 0 && (
              <button 
        ...
        <main className="flex-1 flex flex-col items-center px-3 sm:px-4 md:px-8 py-4 overflow-visible">
          ...
          {paginatedRewards.map((item) => {
            ...
            <div key={item.id} className={`relative hover:scale-105 transition-all duration-200 h-full group ${(isLowStock || isLastOne) ? 'z-10 hover:z-30' : 'z-0 hover:z-30'} ${isOutOfStock ? 'cursor-not-allowed' : ''}`} style={{ overflow: 'visible' }}>
              ...
              {isLowStock && (
                      <div className="absolute top-2 right-2 text-white text-center py-1 px-3 rounded-xl font-bold text-xs shadow-lg z-10 group-hover:z-50 pointer-events-none select-none"
                      style={{ 
              ...
              {isLastOne && (
                      <div className="absolute top-2 right-2 text-[#ffe84a] text-center py-1 px-3 rounded-xl font-bold text-xs z-10 group-hover:z-50 pointer-events-none select-none"
                      style={{ 
                        transform: 'rotate(0deg)',
              ...
              <div className="transition-all duration-200 h-full" style={{aspectRatio: '1180/1756'}}>
              <div 
                className={`relative flex flex-col items-center justify-end transition-all duration-200 w-full h-full overflow-hidden ${tierStyles.className}`}
                style={{
                  borderRadius: '7px',
              ...
              <div className="w-full h-full pt-10 rounded-t-xl px-3 pt-2 flex items-center justify-center overflow-hidden">
                <img 
                  src={(item as any).image || `https://via.placeholder.com/300x200/333333/FFFFFF?text=${encodeURIComponent(item.name)}`}
                  alt={item.name}
              ...
              <div className="px-8 pb-3 pt-1 w-full flex flex-col gap-0 items-center">
              {/* Reward Name - Left aligned */}
              <div className="font-extrabold text-lg text-left w-full text-white drop-shadow-lg" style={{ lineHeight: '25px' }}>{item.name}</div>
              <div className="font-normal text-xs text-left w-full text-white drop-shadow-lg" style={{ lineHeight: '10px' }}>Item Name Model</div>
              
              {/* Points with token icon - Left aligned */}
              <div className="mb-0 pb-3 pt-4 text-left w-full flex items-center gap-1 font-medium text-white" >
                <img src="/pts.png" alt="Points" className="w-4 h-4" />
                <span className="font-bold text-medium text-white" style={{ lineHeight: '20px' }}>{item.points.toLocaleString()}</span>
              </div>
        ...
        {!loading && totalPages > 1 && (
          <div className="flex items-center justify-center gap-1.5 mt-6 sm:mt-8 mb-4 flex-wrap px-2" style={{ fontFamily: 'Poppins' }}>
            {/* First Page */}
            <button
              onClick={() => setCurrentPage(1)}
              disabled={currentPage === 1}
              className={`w-9 h-9 rounded-lg font-bold transition text-base flex items-center justify-center ${
                currentPage === 1 
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => {
              ...
              return (
                <button
                  ...
                  className={`w-9 h-9 rounded-lg font-bold transition text-base ${
                    currentPage === page 
        ...
        {selectedReward && !showSuccessModal && (
          ...
          >
            <motion.div 
              className="shadow-2xl w-full text-white relative overflow-y-auto overflow-x-hidden rounded-lg" 
              style={{ background: '#0B2335', maxHeight: '90vh', maxWidth: '850px' }}
              onClick={(e) => e.stopPropagation()}
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-[60%_40%] gap-0">
                ...
                <div className="flex flex-col gap-2 md:gap-4 pt-4 md:pt-8 px-4 md:px-8 pb-4 bg-gray-800/20">
                  {/* Main Display Image */}
                  <div className="bg-gray-700 rounded-lg flex items-center justify-center overflow-hidden relative" style={{ aspectRatio: '658/403' }}>
                    <img 
                      src={
                ...
                <div className="pt-4 md:pt-6 px-4 md:px-6 pb-4 space-y-2 flex flex-col justify-end">
                    {/* Product Name */}
                    <h1 className="font-bold text-lg md:text-xl" style={{ lineHeight: '1.2' }}>{selectedReward.name}</h1>
                    <p className="text-gray-400 pb-2 text-xs md:text-sm">{selectedReward.name}</p>
                    
                    {/* Description */}
                    <p className="text-sm text-gray-400" style={{ fontSize: '9px' }}>Premium quality reward from our exclusive collection. <br/>Limited availability.</p>
                    
                    {/* Variant Options */}
                    {(selectedReward as any).variants && (
                      <div className="py-1">
                        <label className="font-semibold text-white uppercase mb-1 block" style={{ fontSize: '9px' }}>
                            ...
                            {(selectedReward as any).variants.options.map((option: string) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`relative w-5 h-5 rounded-full transition-all hover:scale-110 ${
                    ...
                    <div className="flex items-center gap-2">
                      <img src="/pts.png" alt="Points" className="w-4 h-4" />
                      <span className="font-bold text-yellow-500" style={{ fontSize: '16px' }}>{selectedReward.points.toLocaleString()}</span>
                    </div>
                    
                    {/* Claiming Process */}
                    <div className="bg-gray-800/50 rounded-lg pt-2 pb-3 px-4 border" style={{ borderColor: '#344459' }}>
                      <h3 className="font-bold text-[#FFD257] mb-1" style={{ fontSize: '9px' }}>Claiming Process:</h3>
                      <ol className="text-gray-300 space-y-1 list-decimal list-inside" style={{ fontSize: '8px' }}>
              ...
              <div className="px-4 md:px-20 pb-4">
                <h3 className="font-bold text-white mb-2 text-sm md:text-base">Complete Your Claim</h3>
