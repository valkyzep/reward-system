...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    if (auth !== 'true') {
      ...
      Promise.all([fetchClaims(), fetchRewards(), fetchRestockingHistory()])
  ...
  const downloadCSV = () => {
    const headers = ['Reward Name', 'Category', 'Current Stock', 'Points']
              ...
              <div className="flex flex-col flex-1 overflow-hidden">
                ...
                <table className="bg-[#1a1d24] rounded-lg overflow-hidden flex-1 w-full flex flex-col">
                    <thead className="bg-yellow-700 flex-shrink-0">
                      <tr className="flex">
                        <th className="px-4 py-2 text-left text-sm font-semibold text-yellow-100 flex-1">Reward Name</th>
